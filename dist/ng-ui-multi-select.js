...
var MultiSelect = {
  ...
  controller: ['$scope', '$attrs', '$timeout', '$element', function ($scope, $attrs, $timeout, $element) {
    ...
    ctrl.removeFocusedOptions = function () {
      angular.forEach($element.find('ui-multi-select-option').find('li.option-container'), function (optionContainer) {
    ...
    ctrl.analyseIfContainsOtherItem = function () {
      $timeout(function () {
        var items = ctrl.getLastItemEnabled($element.find('ui-multi-select-item').last());
        if (items && items[0]) {
    ...
    ctrl.handlingBackspace = function (evt) {
      var itemFocused = $element.find('ui-multi-select-item div.item-container.item-focused');
    ...
    ctrl.handligButtonDown = function (evt) {
      ...
      if (liFocused && liFocused[0]) {
        ...
        var options = $element.find('ui-multi-select-option').find('li.option-container.option-enabled');
        if (options.length > 0) {
...
var _module = angular.module('ngUiMultiSelect', []).component('uiMultiSelect', _multiSelect2.default).component('uiMultiSelectOption', _multiSelectOption2.default).component('uiMultiSelectItem', _multiSelectItem2.default);
